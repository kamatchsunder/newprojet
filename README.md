...
[![Build Status](https://travis-ci.org/mygroup/newprojet.svg?branch=master)](https://travis-ci.org/mygroup/newprojet)
...
```
$ cd to/the/repo
$ rug edit mygroup:newprojet:AddReadme \
...
[issue]: https://github.com/mygroup/newprojet/issues
